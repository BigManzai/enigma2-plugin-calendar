...
config.plugins.calendar.menu = ConfigSelection(default="yes", choices = [
	("yes", _("yes")),
	("no", _("no"))])
...
class Calendar(ConfigListScreen, Screen):
	skin = """
	<!-- Calendar -->
	<screen name="Calendar" position="40,80" size="400,390" >
		<eLabel position="20,610" size="1160,3" backgroundColor="background" transparent="1" zPosition="1" />
		...
		<widget name="monthname" position="50,5" size="355,30" font="Regular; 24" foregroundColor="#00ffcc33" backgroundColor="background" halign="center" transparent="1" />
		<widget source="key_red" render="Label" position="50,355" size="165,30" font="Regular; 22" halign="left" valign="center" foregroundColor="#00f4f4f4" backgroundColor="background" transparent="1" />
		<widget source="key_green" render="Label" position="150,355" size="165,30" font="Regular; 22" halign="left" valign="center" foregroundColor="#00f4f4f4" backgroundColor="background" transparent="1" />
		<widget source="key_yellow" render="Label" position="250,355" size="165,30" font="Regular; 22" halign="left" valign="center" foregroundColor="#00f4f4f4" backgroundColor="background" transparent="1" />
		<widget source="key_blue" render="Label" position="330,355" size="165,30" font="Regular; 22" halign="left" valign="center" foregroundColor="#00f4f4f4" backgroundColor="background" transparent="1" />
		<ePixmap pixmap="/usr/lib/enigma2/python/Plugins/Extensions/Calendar/buttons/key_red.png" position="5,360" size="40,20" alphatest="blend" />
		<ePixmap pixmap="/usr/lib/enigma2/python/Plugins/Extensions/Calendar/buttons/key_green.png" position="110,360" size="40,20" alphatest="blend" />
		<ePixmap pixmap="/usr/lib/enigma2/python/Plugins/Extensions/Calendar/buttons/key_yellow.png" position="210,360" size="40,20" alphatest="blend" />
		<ePixmap pixmap="/usr/lib/enigma2/python/Plugins/Extensions/Calendar/buttons/key_blue.png" position="290,360" size="40,20" alphatest="blend" />
	</screen>"""
	...
	def __init__(self, session):
		...
		self["monthname"] = Label(_("monthname..."))
